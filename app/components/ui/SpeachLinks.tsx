  ...
  return (
    <>
      {speakerDeckEmbeddings.map((speach) => (
        ...
        >
          {speach.embedding}
          <section className='grid grid-cols-1 gap-2 text-zinc-600 dark:text-zinc-200'>
            <a
            ...
            <div className='flex items-center gap-1 text-zinc-500 md:justify-end dark:text-zinc-300'>
